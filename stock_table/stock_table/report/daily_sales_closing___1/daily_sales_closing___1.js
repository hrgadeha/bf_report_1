...
frappe.query_reports["Daily Sales Closing - 1"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
		...
		},
		{
			...
			"label": __("Account"),
			"fieldtype": "Select",
			"options": ["", __("SH Cash - B"), __("SN Cash - B"),
                                __("SZ Cash - B"), __("AH Cash - B"), __("SH KNET - B"), __("SN KNET - B"), __("SZ KNET - B"),
				__("AH KNET - B"), __("SH Cheque - B"), __("SN Cheque - B"), __("SZ Cheque - B"), __("AH Cheque - B"),
				__("CHEQUE IN HAND - B"), __("Gift Discount - B")]
		},
		{
